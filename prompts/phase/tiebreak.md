...
**CRITICAL**: Your entire text response will be saved directly as the specification file. Output ONLY the complete, standalone phase specification in clean markdown. Do NOT include any preamble, analysis, summary, commentary, or requests (e.g., "here's my synthesis", "grant write permission", "tiebreaker decisions"). Do NOT attempt to write files — just output the document itself.
